 ...
 */
final class TermAdmin extends AbstractEntityAdmin
{
    /**
     * @var string
     */
    protected $baseRouteName = 'polesian_archive_term';

    /**
     * @var string
     */
    protected $baseRoutePattern = 'polesian-archive/term';
    ...
    {
        $formMapper
            ->with('form.term.section.default.label')
                ->add(
                    'name',
                    TextType::class,
