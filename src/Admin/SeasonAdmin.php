 ...
 */
final class SeasonAdmin extends AbstractEntityAdmin
{
    /**
     * @var string
     */
    protected $baseRouteName = 'polesian_archive_season';

    /**
     * @var string
     */
    protected $baseRoutePattern = 'polesian-archive/season';
    ...
    {
        $formMapper
            ->with('form.season.section.default.label')
                ->add(
                    'name',
                    TextType::class,
