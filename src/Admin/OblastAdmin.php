 ...
 */
final class OblastAdmin extends AbstractEntityAdmin
{
    /**
     * @var string
     */
    protected $baseRouteName = 'polesian_archive_oblast';

    /**
     * @var string
     */
    protected $baseRoutePattern = 'polesian-archive/oblast';
    ...
    {
        $formMapper
            ->with('form.oblast.section.default.label')
                ->add(
                    'name',
                    TextType::class,
