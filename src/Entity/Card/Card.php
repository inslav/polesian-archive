...
class Card
{
     ...
     * @var Village
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Card\Village", inversedBy="cards")
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\Card\Question")
     */
    private $questions;
     ...
     * @var Season|null
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Card\Season", inversedBy="cards")
     */
    private $season;
     ...
     * @var Collection|Term[]
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\Card\Term", inversedBy="cards")
     */
    private $terms;
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\Card\Collector", inversedBy="cards")
     */
    private $collectors;
