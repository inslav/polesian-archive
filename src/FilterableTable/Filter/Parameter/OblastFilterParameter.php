 ...
 */
final class OblastFilterParameter implements FilterParameterInterface, ExpressionBuilderInterface
{
    ...
    {
        return [
            'label' => 'controller.card.list.filter.oblast',
            'attr' => [
                'class' => '',
    ...
    public function buildWhereExpression(QueryBuilder $queryBuilder, $formData, string $entityAlias): ?string
    {
        ...
        $queryBuilder
            ...
            ->innerJoin(
                $villageAlias.'.raion',
                $raionAlias = $this->aliasFactory->createAlias(static::class, 'raion')
            )
        ;
        ...
        foreach ($oblasts as $index => $oblast) {
            $queryBuilder->setParameter(
                $oblastIdParameter = $this->parameterFactory->createParameter(
                    $oblastFieldAlias = $raionAlias.'.oblast',
                    $index
                ),
                $oblast->getId()
            );

            $orWhereClauses[] = $queryBuilder->expr()->eq($oblastFieldAlias, $oblastIdParameter);
        }
